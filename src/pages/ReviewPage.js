        ...
        <Row>
          <Col>
            ...
            >
              ...
              <div className='shadow  m-auto p-4' style={{ width: '80%' }}>
                <p className=''>Previously Written Prescriptions</p>
                <Row>
                  {/* <Col
                    md={5}
                    className='d-flex justify-content-between align-items-center rounded-3 mt-2'
                    style={{
                      backgroundColor: '#FEF3D5',
                    }}
                  >
                    <p className='py-3 my-0 text-muted'>
                  ...
                  <Col
                    md={5}
                    className='d-flex justify-content-between align-items-center rounded-3 mt-2 ms-0 ms-md-3'
                    style={{
                      backgroundColor: '#FEF3D5',
                    }}
                  >
            ...
            >
              ...
              <div className=' m-auto mobw90' style={{ width: '80%' }}>
                <button
                  ...
                  style={{ backgroundColor: '#FAB915' }}
                >
                  <img src='./Path 32617.svg' alt='plus' />
            ...
            <div className='shadow m-auto' style={{ width: '80%' }}>
            ...
            <div className='shadow m-auto' style={{ width: '80%' }}>
              <div className='m-auto py-4' style={{ width: '80%' }}>
                ...
                <button
                  className='btnn py-2 px-4 border-0 shadow rounded-5 mt-2 text-white'
                  style={{ backgroundColor: '#FAB915' }}
                >
                  <span className='me-4'>Next</span>
                  <img src='/Component 638 – 1.svg' width='50' height='30' />
                      
                </button>
              </div>
            </div>
